...
<body onload="connect();">
	<br>
	<br>
	<img src=resources/img/travel.png width=400 height=200>
	<div class="alert alert-danger" style="width: 500px; background: #7ac0cf">
		<div style="color: black">여행 성향 테스트를 시작합니다 ! 시작을 원하시면 1을 입력해주세요.</div>
		<br>
		<div id="response" style="color: black">
		...
		<tr>
			...
			<td><button id="sendMessage" onclick="sendMessage();"class="btn btn-danger">Send</button></td>
		</tr>
		</table>
		</div>
	</div>
