			...
			<div class="row gx-4 gx-lg-5 justify-content-center">
				<div class="col-md-10 col-lg-8 col-xl-7">
					<div class="post-heading">
						<h1>국제게임전시회 지스타</h1>
						<h2 class="subheading">국제게임전시회</h2>
						<span class="meta"> 부산 해운대구 2023. 11. 16. ~ 2023. 11. 19. </span>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row gx-4 gx-lg-5 justify-content-center">
				<div class="col-md-10 col-lg-8 col-xl-7">
					<a href="#!"><img class="img-fluid"
						src="resources/assets/img/5.jpg" alt="..." /></a> <span
						class="caption text-muted">국제게임전시회 지스타</span>
					<h2 class="section-heading">상세 정보</h2>
					<p> 게임전시 관람, 신작게임 체험, 이벤트 참여 등 다채로운 경험을 할 수 있다.</p>
